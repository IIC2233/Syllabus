...
class Juego(QObject):
    ...
    def fin_meteorito(self, id_meteorito: int, daño: bool) -> None:
        """
        Método encargado de gestionar el fin de un meteorito.
        Esto implica avisar al frontend cuando hay que eliminar,
    ...
    def click_pantalla(self, x: int, y: int) -> None:
        """
        Método encargado de buscar el meteorito activo más cercano
        al click del mouse y si está dentro del radio esperado lo destruye.
        """
