...
if __name__ == '__main__':
    ...
    # Acá el código presenta 3 errores:
    # a) ControladorLogico no es un QObject, por lo que no se pueden
    #    conectar las señales.
    # b) La señal "senal_empezar" del ControladorLogico se conecta a los
    #    métodos "show" ya ejecutados, por lo que no permite que
    #    se vean las ventanas.
    # c) La señal "senal_volumen" de VentanaControlRemoto está definida para
