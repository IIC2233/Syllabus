...
class VentanaJuego(QWidget):
    ...
    def recibir_senal_backend(self, mensaje: dict):
        tipo = mensaje['tipo']
        match tipo:
            case 'empezar_juego':
                self.empezar_juego()
            case 'aparecer_meteorito':
                self.aparecer_meteorito(*mensaje['args'])
            case 'mover_meteorito':
                self.mover_meteorito(*mensaje["args"])
            case 'remover_meteorito':
                self.remover_meteorito(*mensaje["args"])
            case 'actualizar_poblacion':
                self.actualizar_poblacion(*mensaje["args"])
