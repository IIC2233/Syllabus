...
class VerificarConsultasAnimesPorEstreno(unittest.TestCase):
    ...
    def test_resultado_1_estreno(self):
        ...
        for key in respuesta_esperada:
            text = f'Año {key}. Se entrega {estrenos[key]} ' \
                   f'pero se espera {respuesta_esperada[key]}'
    ...
    def test_resultado_varios_repetidos(self):
        """
        Verifica el contenido cuando solo hay varios animes,
        algunos con misma fecha y otros no
        """
