...
from tests_publicos.solution.test_9 import *
...
class TestPlanetasPorEstadisticasCargaDatos(unittest.TestCase):
    ...
    def test_0(self):
        ...
        path_minerales = os.path.join("data", tamano, "Mineral.csv")
        path_planeta_minerales = os.path.join("data", tamano, "PlanetaMineral.csv")
        path_planetas = os.path.join("data", tamano, "Planeta.csv")
