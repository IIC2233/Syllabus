...
class TestNavesDeMaterial(unittest.TestCase):
    ...
    def test_0(self):
        """
        Verifica que se retorne lista vacía cuando no hay naves con la capacidad dentro del rango.
        """
        ...
        resultado_estudiante = naves_de_material(generador_naves, "Cobre")
    ...
    def test_1(self):
        """
        Verifica que la función pueda recibir un generador vacío.
        """

        generador_vacio = (nave for nave in [])

        resultado_estudiante = naves_de_material(generador_vacio, "Titanio")
    ...
    def test_2(self):
        """
        Verifica que se retorne la única nave con el material.
        """
    ...
    def test_3(self):
        """
        Verifica que se retorne todas las naves que contienen el material (3).
        """
    ...
    def test_4(self):
        """
        Verifica que se retorne las naves que tienen el material (5).
        """
