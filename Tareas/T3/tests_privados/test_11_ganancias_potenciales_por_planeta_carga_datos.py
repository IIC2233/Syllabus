...
class TestGananciasPotencialesPorPlanetaCargaDatos(unittest.TestCase):
    ...
    def test_0(self):
        ...
        """
        size = "out_new_S"
        path_minerales = os.path.join("data_new", size, "Mineral.csv")
    ...
    def test_1(self):
        ...
        path_planetas = os.path.join("data_new", size, "Planeta.csv")
        path_planeta_minerales = os.path.join("data_new", size, "PlanetaMineral.csv")
        precios = diccionario_precios_out_new_S
    ...
    def test_2(self):
        ...
        path_planetas = os.path.join("data_new", size, "Planeta.csv")
        path_planeta_minerales = os.path.join("data_new", size, "PlanetaMineral.csv")
        precios = diccionario_precios_out_new_M
    ...
    def test_4(self):
        ...
        path_planetas = os.path.join("data_new", size, "Planeta.csv")
        path_planeta_minerales = os.path.join("data_new", size, "PlanetaMineral.csv")
        precios = diccionario_precios_out_new_L
