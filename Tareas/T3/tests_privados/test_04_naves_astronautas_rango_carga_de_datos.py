...
from tests_privados.solution.test_4 import (
...
class TestNavesAstronautasRango(unittest.TestCase):
    ...
    def test_1(self):
        ...
        resultado_estudiante = naves_astronautas_rango(g_t, 1, 2)
    ...
    def test_2(self):
        ...
        resultado_estudiante = naves_astronautas_rango(g_t, 1, 3)
    ...
    def test_3(self):
        ...
        resultado_estudiante = naves_astronautas_rango(g_t, 3, 2)
    ...
    def test_4(self):
        ...
        resultado_estudiante = naves_astronautas_rango(g_t, 4, 2)
