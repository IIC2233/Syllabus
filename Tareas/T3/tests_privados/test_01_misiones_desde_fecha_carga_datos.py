...
from tests_privados.solution.test_1 import *
...
class TestMisionesPorFechaCargaDatos(unittest.TestCase):
    ...
    def test_0(self):
        ...
        datos = os.path.join("data_new", tamano, "Mision.csv")
        
        generador_misiones = cargar_mision(datos)
        
        resultado_estudiante = misiones_desde_fecha(generador_misiones, "2022-10-05", False)
    ...
    def test_1(self):
        ...
        resultado_estudiante = misiones_desde_fecha(generador_misiones, "2022-10-05", True)
    ...
    def test_2(self):
        ...
        resultado_estudiante = misiones_desde_fecha(generador_misiones, "2024-04-08", False)
    ...
    def test_3(self):
        ...
        resultado_estudiante = misiones_desde_fecha(generador_misiones, "2024-04-08", True)
    ...
    def test_4(self):
        ...
        resultado_estudiante = misiones_desde_fecha(generador_misiones, "2025-01-01", False)
    ...
    def test_5(self):
        ...
        resultado_estudiante = misiones_desde_fecha(generador_misiones, "2025-01-01", True)
